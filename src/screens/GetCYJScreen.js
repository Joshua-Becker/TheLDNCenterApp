      ...
      .then(async (data) => {
        ...
        for (field in fields) {
          if (!identifiers.includes(fields[field]['name'])) {
            ...
            fields[field]['value'] = await group.encrypt(
    ...
    <View style={styles(colors).container}>
      ...
      <View style={styles(colors).disclaimerBox}>
        <Text style={styles(colors).disclaimerText}>
          Your details from The LDN Health Center website can be fetched here.
          Simply input your website login details below to gether them. Then all
          your resources can be matched to your preferences. And if you ever
          change your details on the website, make sure to come back here to
          update these as well.
        </Text>
      </View>
      <View style={styles(colors).disclaimerBox}>
        <Text style={styles(colors).disclaimerText}>
          And if you ever change your details on the website, make sure to come
          back here to update these as well.
        </Text>
      </View>
      <View>
        <FormInput
